...
async def go_to_cats_menu(message: types.Message):
    await message.answer("Telefonlarga o'tish uchun sahifani tanlang...", reply_markup=cats_markup)
...
async def go_to_products_menu(message: types.Message, state: FSMContext):
    ...
    await message.answer("Batafsil ma'lumot uchun telefonni tanlang...", reply_markup=markup)
