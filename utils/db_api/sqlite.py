...
"""
    ...
    def add_user(self, id: int, name: str, user_name: str, language: str = 'uz', phone_number = None):
        # SQL_EXAMPLE = "INSERT INTO Users(id, Name, email) VALUES(1, 'John', 'John@gmail.com')"

        sql = """
        INSERT INTO Users(id, Name, user_name, phone_number, language) VALUES(?, ?, ?, ?, ?)
        """
        self.execute(sql, parameters=(id, name, user_name, phone_number, language), commit=True)
    ...
    def add_order(self, user_id: int, total_price: float, lat: float, lon: float, phone_number: str):
        # SQL_EXAMPLE = "INSERT INTO Users(id, Name, email) VALUES(1, 'John', 'John@gmail.com')"

        sql = """
        INSERT INTO Orders(user_id, total_price, lat, lon, phone_number) VALUES(?, ?, ?, ?, ?)
        """
        self.execute(sql, parameters=(user_id, total_price, lat, lon, phone_number), commit=True)    
